...
const adminupdate = () => {
    ...
    useEffect(()=>{
        ...
        if(model=='user'){
                ...
                axios.get(`/api/get/userone?_id=64ecbc547b3ea8f4563dc959`).then(res=>{
                    console.log(res)
            ...
            try{
                ...
                axios.get(`/api/admin/plan?_id=64ecbe9c7b3ea8f4563dc979`).then(res=>{
                    if(res.data.success==true){
    ...
    alert('Server error')
            ...
            try{
                ...
                axios.get(`/api/get/requestbyid?_id=64eb3c6c6cd743a3ea234780`).then(res=>{
                    if(res.data.success==true){
                    set_id(res.data.result._id)
                    setemail(res.data.result.email)
                    setstatus(res.data.result.status)
