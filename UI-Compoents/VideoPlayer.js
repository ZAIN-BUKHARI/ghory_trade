...
const VideoPlayer = () => {
  ...
  return (
    ...
    <iframe  id='zain' src={`https://www.youtube.com/embed/${videoID}?autoplay=1`} title="YouTube video player" frameborder  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
}else
{
  return (
    ...
    <main className="TestBody-container-mob">
        <section className="TestBody-main-video">
    <iframe  id='zain' src={`https://www.youtube.com/embed/${videoID}?autoplay=1`} frameborder title="YouTube video player"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
